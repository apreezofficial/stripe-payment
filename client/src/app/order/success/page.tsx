      ...
      {isSuccess ? (
        <>
          ...
          <p className="text-gray-600 mb-6">
            ...
            confirmed. We will send a receipt to your email shortly.
          </p>
          {sessionId && (
        ...
        <>
          ...
          <p className="text-gray-600 mb-6">
            Your payment could not be processed, or you canceled the checkout
            process. Please verify your payment details and try again.
          </p>
